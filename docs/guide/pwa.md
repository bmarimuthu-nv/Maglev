...
Maglev's web interface is a fully-featured PWA that can be installed on your phone for a native app-like experience.

## What is PWA?

A Progressive Web App (PWA) is a web application that can be installed on your device and works like a native app:

- **Home screen icon** - Launch Maglev like any other app
- **Full screen mode** - No browser chrome, immersive experience
- **Offline support** - Basic functionality works without internet
- **Auto-updates** - Always get the latest version

## Installing Maglev PWA

### Android (Chrome/Edge)

1. Open Maglev in Chrome or Edge browser
2. Look for the **"Install Maglev"** banner at the bottom
3. Tap **"Install"**
4. Maglev appears on your home screen
...
1. Open Maglev in Safari browser
...
1. Open Maglev in your browser
2. Click the install icon in the address bar (⊕)
3. Or use the menu: **"Install Maglev..."**
4. Maglev opens as a standalone window

## PWA Features

### Offline Mode

When offline, Maglev can:
...
Maglev automatically checks for updates:
...
Maglev uses intelligent caching:
...
Maglev supports push notifications to alert you when agents need attention.

### Enable Notifications

1. Open Maglev - a permission popup appears automatically
...
Maglev shows different UI based on install status:
...
3. Select "Uninstall Maglev"

### Clearing Cache

If you experience issues:

1. Open Maglev in browser (not installed version)
...
On Android, disable battery optimization for Maglev to ensure:
- Background sync works reliably
- Notifications arrive promptly

Settings → Apps → Maglev → Battery → Unrestricted

### Data Usage

Maglev uses minimal data:
...
You can install Maglev on multiple devices:

- All devices use the same server
- Sessions sync across devices
- The same hub remains available across devices once each device signs in
