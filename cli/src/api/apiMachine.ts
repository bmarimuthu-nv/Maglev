/**
 * WebSocket client for machine/runner communication with maglev-hub
 */
...
import type { Update, UpdateMachineBody } from '@maglev/protocol'
...
export class ApiMachineClient {
    ...
    setRPCHandlers({ spawnSession, stopSession, requestShutdown }: MachineRpcHandlers): void {
        this.rpcHandlerManager.registerHandler('spawn-shell-session', async (params: any) => {
            const { directory, sessionId, resumeSessionId, machineId, approvedNewDirectoryCreation, token, sessionType, worktreeName, pinned, startupCommand, displayName } = params || {}
