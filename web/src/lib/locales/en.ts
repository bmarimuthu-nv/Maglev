export default {
  ...
  // Session actions
  'session.action.edit': 'Edit details',
  'session.action.rename': 'Rename',
  'session.action.archive': 'Archive',
  'session.action.delete': 'Delete',
  'session.action.close': 'Close',
  ...
  'dialog.edit.name': 'Session name',
  'dialog.edit.namePlaceholder': 'Session name',
  'dialog.edit.directory': 'Start directory',
  'dialog.edit.directoryPlaceholder': '/path/to/project',
  'dialog.edit.directoryRequired': 'Please enter a directory.',
  'dialog.edit.saving': 'Saving…',
  'dialog.edit.error': 'Failed to save session details. Please try again.',
  ...
  'dialog.close.title': 'Close Session',
  'dialog.close.description': 'Close and delete "{name}"? Active sessions will be disconnected and pinned shells will be unpinned.',
  'dialog.close.confirm': 'Close',
  'dialog.close.confirming': 'Closing…',
  ...
  'newSession.saved': 'Saved folders',
  'newSession.saveCurrent': 'Save current folder',
  'newSession.savedCurrent': 'Folder saved',
  'newSession.removeSaved': 'Remove saved folder',
  'newSession.recent': 'Recent paths',
  'newSession.worktrees': 'Detected worktrees',
  'newSession.worktrees.refresh': 'Refresh',
  'newSession.worktrees.loading': 'Loading…',
  'newSession.worktrees.empty': 'No worktrees detected yet.',
  ...
  // Install prompt
  'install.title': 'Install Maglev',
  'install.description': 'Add Maglev to your home screen for quick access.',
