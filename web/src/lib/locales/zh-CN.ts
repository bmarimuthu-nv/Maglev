export default {
  ...
  'login.server.description': '设置 Maglev 服务器地址以使用 API 和实时更新。',
  ...
  'newSession.saved': '已保存目录',
  'newSession.saveCurrent': '保存当前目录',
  'newSession.savedCurrent': '目录已保存',
  'newSession.removeSaved': '删除已保存目录',
  'newSession.recent': '最近路径',
  'newSession.worktrees': '检测到的工作树',
  'newSession.worktrees.refresh': '刷新',
  'newSession.worktrees.loading': '加载中…',
  'newSession.worktrees.empty': '暂未检测到工作树。',
  ...
  // Install prompt
  'install.title': '安装 Maglev',
  'install.description': '将 Maglev 添加到主屏幕以便快速访问。',
  'install.button': '安装',
