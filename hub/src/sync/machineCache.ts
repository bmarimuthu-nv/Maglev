...
const machineMetadataSchema = z.object({
    ...
    maglevCliVersion: z.string().optional(),
...
export class MachineCache {
    ...
    refreshMachine(machineId: string): Machine | null {
        ...
        const metadata = (() => {
            ...
            const maglevCliVersion = typeof data.maglevCliVersion === 'string' ? data.maglevCliVersion : 'unknown'
            ...
            const maglevHomeDir = typeof data.maglevHomeDir === 'string' ? data.maglevHomeDir : undefined
            const maglevLibDir = typeof data.maglevLibDir === 'string' ? data.maglevLibDir : undefined
            return { host, platform, maglevCliVersion, displayName, homeDir, maglevHomeDir, maglevLibDir }
        })()
